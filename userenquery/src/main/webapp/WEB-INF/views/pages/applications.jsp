...
<div id="printApplicationForm" class="col-md-8" style="border: 1px dotted #ccc; margin: 0 auto; float: none; margin-top: 40px; padding-top: 15px;"> <!-- style="display:none;" -->
	...
	<table class="table table-bordered"  style="margin-bottom:15px;">
		<tbody>
			...
			<tr>
				<td colspan="2">
					I/We, the Applicant/s mentioned below, request that I/we be allotted a residential flat / unit / apartment / commercial unit in terms of Annexure A in this Application <span id="projectPhas"></span> in "<span id="projectNameLocation"></span>", <!-- project situated at ______________________ ("Project") --> details whereof are as under.
				</td> 
			</tr>
		</tbody>
	</table>	
