...
<a class="printFloat" style="bottom: 40px;" onclick="closingManagerList()" data-toggle="tooltip" title="Assigned List">
	...
	<script src="<c:url value='/resources/js/bankdetails.js?v=16' />"></script>
 ...
 <script src="<c:url value='/resources/js/separate/inventory.js?v=16'/>"></script>
...
<script src="<c:url value='/resources/js/enquiryRequest/common.js?v=16'/>"></script>
<script src="<c:url value='/resources/js/separate/costsheet.js?v=16'/>"></script>
<script src="<c:url value='/resources/js/separate/webcamAttachmentCS.js?v=16'/>"></script>


<script src="<c:url value='/resources/js/separate/storeEOIPaymentDtl.js?v=16'/>"></script>
