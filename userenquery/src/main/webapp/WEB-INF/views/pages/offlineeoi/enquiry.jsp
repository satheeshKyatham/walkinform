...
<div class="modal fade" id="multiEnq" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
	...
	<script src="<c:url value='/resources/js/springForm.js?v=18.26' />"></script>
	<script src="<c:url value='/resources/js/commonValidation.js?v=18.26' />"></script>
	<script src="<c:url value='/resources/js/utility.js?v=18.26' />"></script>
	<script src="<c:url value='/resources/js/offline/enquiry.js?v=18.26' />"></script>	
