...
<body>
	...
	<script src="<c:url value='/resources/js/separate/scheme.js?v=18.01'/>"></script>
	
	<script src="<c:url value='/resources/js/separate/schemeMapping.js?v=18.01'/>"></script>
	<script src="<c:url value='/resources/js/separate/schemeMaster.js?v=18.01'/>"></script>
