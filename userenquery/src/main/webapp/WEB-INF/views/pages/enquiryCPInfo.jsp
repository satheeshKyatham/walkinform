...
<div class="modal fade" id="multiEnq" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
	...
	<script src="<c:url value='/resources/js/enquiryRequest/enquiryCPRequest.js?v=20' />" /></script>
	...
	<script src="<c:url value='/resources/js/separate/storeEOIPaymentDtlCP.js?v=20' />"></script>
