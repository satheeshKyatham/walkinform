...
<div class="well center-block">
	<div class="form-inline">
		...
		<div class="form-group">
			...
			<input class="form-control" type="date" name="" id="txtpaymentEOIFromDate">
		</div>
		<div class="form-group">
			<label>To Date</label> 
			<input class="form-control" type="date" name="" id="txtpaymentEOIToDate">
		</div>
		<div class="form-group">
			<input class="form-control" type="button" value="Search" name="Search" onclick="getPaymentEOIReport()"/>
		</div>
	</div>
...
<div class="wrapperEOIRepo2">
	...
	<div class="divEOI2" style="overflow: auto;">
		<table class="table table-bordered" id="paymentEOIReportTable">
			<thead>
				<tr>
					<th>ENQ Name</th>
					<th>Customer Name</th>
