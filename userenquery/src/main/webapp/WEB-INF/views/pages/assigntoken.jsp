...
<script src="<c:url value='/resources/js/enquiryRequest/assignToken.js?v=18.05'/>"></script>
<script src="<c:url value='/resources/js/salesdesk.js?v=18.05'/>"></script>
<script src="<c:url value='/resources/js/sweetalert.min.js'/>"></script>

<script src="<c:url value='/resources/js/separate/eoiData.js?v=18.05'/>"></script>
