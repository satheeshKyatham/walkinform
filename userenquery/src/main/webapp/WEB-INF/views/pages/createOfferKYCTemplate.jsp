...
<table class="table table-bordered"  style="margin-bottom:15px;">
   <tbody>
      ...
      <tr>
         <td colspan="2" id="applicantPhotosOffer"></td>
      </tr>
      <tr>
         <td colspan="2">
...
<div id="inIndividualCaseOffer"></div>
<div id="inComapnyCaseOffer"></div>
...
<table class="table table-bordered"  style="margin-bottom:15px;">
   ...
   <tr>
      <td colspan="2" id="carParkSpaceCount"></td>
   </tr>
   <tr>
      <th>E</th>
      <td>Specification(s) of Flat/Unit</td>
      <td colspan="2">
         As per <b>Annexure C.</b>
   ...
   <tr>
      <th rowspan="8" style="vertical-align: top;">2</th>
      <th colspan="4">
      	<div style="margin-bottom:10px;">Sale Consideration</div>
      </th>
   </tr>
   <tr>
      <th>A</th>
   ...
   <tr>
      ...
      <td colspan="2" id = "carParkCharges"></td>
   </tr>
   <tr>
      <th>D</th>
      <td>Club House and Infrastructure charges</td>
      <td colspan="2" id="cniCharges"></td>
   </tr>
   <tr>
      <th>E</th>
      <td>Facilities</td>
      <td colspan="2" id="facilitiesCharges"></td>
   </tr>
   ...
   <tr>
      ...
      <th colspan="2" style="height:60px;">
         ...
         <div style="line-height: 24px; padding-top:10px;"><b style="word-break: break-all;">(Rupees <span id="totalScInWordOffer"></span> Only)</b></div>
      </th>
   </tr>
   ...
   <tbody>
      ...
      <tr>
         ...
         <td colspan="2">
            ...
            <div style="padding-top:15px;">I/We hereby understand that any payment shall be subject to realization and/or actual credit in Developer's bank account. </div>
         </td>
      </tr>
      <tr>
         <th>13.</th>
         <td colspan="2"> "I further confirm and acknowledge that I have read and understood the information/documents uploaded by the Developer on RERA website: rera.karnataka.gov.in including the section with respect to "Advocate Search Report" and hereby declare that I have submitted this Application Form with full knowledge of all the disclosures including disclosures pertaining to litigations contained on RERA website and undertake not to make any claim against the Developer with regards thereto." </td>
      </tr>
   </tbody>
</table>
