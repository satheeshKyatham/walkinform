...
<div>
	...
	<script type="text/javascript" src="<c:url value='/resources/js/jquery.countdownTimer.js?v=18.05'/>"></script>
	
	<script src="<c:url value='/resources/js/separate/costsheet.js?v=18.05'/>"></script>
