   ...
   <nav class="navbar topMainBar mobileTopBar">
	...
	<div class="container formCol swipeCard posRelative">
		...
		<div class="tab-content formTabCont">
			...
			<!-- Added By Satheesh - Adding CP name before generate OTP Start-->
			<div class="tab-pane" id="cpdotp_div">
				<%@ include file="/WEB-INF/views/pages/cpdotp.jsp" %>
			</div>	
			<div id="enquiryform_div" style="display: none;">
				...
				<div class="row "> <!-- bounceInLeft animated -->
					...
					<div>
						<div class="col-md-12 radioBtnWrp mrgT0">
							...
							<div class="radioBtnCol" data-toggle="buttons">
							  <label class="btn btn-primary active hideChannelPartnerTypeOTP disableInputs enquiryFields" labelName="isReferredByChannelPartner" value="CP" >
							  ...
							  <label class="btn btn-primary hideChannelPartnerTypeOTP disableInputs enquiryFields" labelName="isReferredByChannelPartner"  value="O" >
						...
						<div id="isReferredByChannelPartnerOTPO" class="sourceColOTP animated" style="display: none;">
							<div class="col-md-6 col-xs-12">
								<div class="group">
									...
									<span class="highlight"></span><span class="bar"></span> <!-- requiredField -->
									<label>Enter channel partner name <strong class="mndt">*</strong></label>
								</div>
							</div>	
							<div class="clearfix"></div>
					...
					<div class="formDivider" >
						...
						<div class="col-md-12 col-sm-12 col-xs-12 radioBtnWrp padMLR15" radioName="desiredUnitType" id="desiredUnitType">
							...
							<div class="radioBtnCol requiredRadio" data-toggle="buttons">
							     ...
							     <label class='btn btn-primary '> <!-- enquiryFields -->
							          <input type='radio' id='desiredUnitType3' class="desiredUnitType " name='enquiryReport.desiredUnitType' value='4 BHK'>4 BHK</label>
							     
							     <label class='btn btn-primary '> <!-- enquiryFields -->
							          <input type='radio' id='desiredUnitType4' class="desiredUnitType " name='enquiryReport.desiredUnitType' value='Others'>Others</label>
...
<div class="modal fade" id="multiEnq" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
	...
	<script src="<c:url value='/resources/js/index.js?v=18.25' />"></script>
