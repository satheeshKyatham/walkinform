   ...
   ********************/
        ...
        _setFlag: function(countryCode, isInit) {
            ...
            if (!isInit && prevCountry.iso2 !== countryCode) {
              ...
              //Added by satheesh for onclick country call
                getCustomCountryData(this.selectedCountryData);
...
function getCustomCountryData(dataInput)
{
	//alert(dataInput.dialCode);
