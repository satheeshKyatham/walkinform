	...
	function onUserSelect()
	{
		...
		{	
			...
			$.getJSON(urlPP, function (data) {
				...
				var val = $("<tr><td><a target='_blank'  href='"+rowurl+"'>"+value.type+value.queue+"</a></td><td><label>"+contactName+"</label></td><td>"+prorityNo+"</td><td>"+value.closing_manager_name__c+"</td><td>"+value.createdBy+"</td><td>"+value.partnertype+"</td><td>"+userlist+"</td><td><input type='button' value='Assign' onclick='asigneddatUpdate("+value.nv_token_id+",\""+value.type+value.queue+"\",\""+name+"\",\""+mobileNo+"\")'/></td></tr>");
		...
		function getAssignedList()
		{
			...
			$.getJSON(urlPPtoken, function (data) {
				$.each(data, function (index, value) {
					...
					$("#assinedDetails tbody").append("<tr><td><a target='_blank'  href='"+rowurl+"'>"+value.type+value.queue+"</a></td><td><label id='id'>"+value.contact_name+"</label></td><td>"+prorityNo+"</td><td>"+value.closing_manager_name__c+"</td><td>"+value.isdone+"</td><td>"+value.partnertype+"</td><td>"+userlist+""+value.user_name+"</td>"+editButtonShow+"</tr>");
