			...
			if (!"".equals(projectsfid) && !"".equals(propid)) {
				...
				if(inventoryStatusCondition) {
					...
					if((offerid!=null && offerid.length()==18)) {
						if("a1l6F0000081xb4QAA".equals(projectsfid) || "a1l2s00000000X5AAI".equals(projectsfid) || "a1l2s00000003VlAAI".equals(projectsfid)  || "a1l6F000003TXloQAG".equals(projectsfid) || "a1l2s000000PGu3AAG".equals(projectsfid)  || "a1l2s000000PGu8AAG".equals(projectsfid) || "a1l2s000000PGuDAAW".equals(projectsfid) || "a1l2s000000PGuIAAW".equals(projectsfid) || "a1l2s000000PGuNAAW".equals(projectsfid) || "a1l2s000000PGuSAAW".equals(projectsfid)) {
