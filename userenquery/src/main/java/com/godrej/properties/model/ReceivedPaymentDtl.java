...
@Entity
@Table(name="salesforce.propstrength__received_payment__c")
public class ReceivedPaymentDtl implements Serializable{
	private static final long serialVersionUID = 1L;
	@Id @GeneratedValue(strategy = GenerationType.IDENTITY)
	
	@Column(name="id") private int id;
	
	@Column(name="propstrength__payment_type__c") private String propstrength__payment_type__c;
	@Column(name="propstrength__bank_name_auto__c") private String propstrength__bank_name_auto__c;
	@Column(name="propstrength__crn_no__c") private String propstrength__crn_no__c;
	
	@Column(name="propstrength__cheque_demand_draft_number__c") private String propstrength__cheque_demand_draft_number__c;
